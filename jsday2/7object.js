/*
    자바스크립트 데이터타입 : 원시데이터타입(number,string, boolean,underfined,null 등) 을 제외한 함수,배열도 객체 object입니다.
                : 데이터 타입확인연산자 typeof
...
console.log('이름 : ' +person.name['name'])            
console.log('나이 : ' + person.age)
console.log('나이 : ' + person.age['age'])
console.log(person)
person.sayHi();
...
//          data.go.kr 에서 json 문자열(경량데이터)을 제공하는 사례를 찾아보세요.
//                                  REST 서비스
